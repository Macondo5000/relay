...
export default function App() {
  ...
  const [linkApps, setLinkApps] = useState<AppItem[]>([
    ...
    { id: 'outcal',     name: 'Outlook Calendar',   linked: false, category: ['Featured', 'Calendars'],         iconBg: '#0078D4', iconColor: '#fff', iconLabel: 'OC', authType: 'oauth' },
    ...
    { id: 'outlook',    name: 'Outlook',            linked: true,  category: ['Featured', 'Emails & Messengers'], iconBg: '#0078D4', iconColor: '#fff', iconLabel: 'O', authType: 'oauth' },
    { id: 'notion',     name: 'Notion',             linked: true,  category: ['Featured', 'Files & Docs'],      iconBg: '#000000', iconColor: '#fff', iconLabel: 'N', authType: 'oauth' },
    { id: 'gdrive',     name: 'Google Drive',       linked: false, category: ['Featured', 'Files & Docs'],      iconBg: '#34A853', iconColor: '#fff', iconLabel: 'GD', authType: 'oauth' },
    ...
    { id: 'gdocs',      name: 'Google Docs',        linked: false, category: ['Featured', 'Files & Docs'],      iconBg: '#4285F4', iconColor: '#fff', iconLabel: 'GD', authType: 'oauth' },
    ...
    { id: 'zoom',       name: 'Zoom',               linked: true,  category: ['Featured', 'Meeting'],           iconBg: '#2D8CFF', iconColor: '#fff', iconLabel: 'Z', authType: 'oauth' },
    { id: 'slack',      name: 'Slack',              linked: true,  category: ['Featured', 'Emails & Messengers'], iconBg: '#4A154B', iconColor: '#fff', iconLabel: 'S', authType: 'oauth' },
    { id: 'teams',      name: 'Microsoft Teams',    linked: false, category: ['Emails & Messengers', 'Meeting'], iconBg: '#6264A7', iconColor: '#fff', iconLabel: 'T', authType: 'oauth' },
    { id: 'figma',      name: 'Figma',              linked: true,  category: ['Files & Docs', 'Tanka Official'], iconBg: '#F24E1E', iconColor: '#fff', iconLabel: 'F', authType: 'oauth' },
    { id: 'jira',       name: 'Jira',               linked: false, category: ['Data & Analytics'],               iconBg: '#0052CC', iconColor: '#fff', iconLabel: 'J', authType: 'oauth' },
    { id: 'confluence', name: 'Confluence',         linked: false, category: ['Files & Docs'],                   iconBg: '#172B4D', iconColor: '#fff', iconLabel: 'C', authType: 'oauth' },
    { id: 'github',     name: 'GitHub',             linked: true,  category: ['Files & Docs', 'Others'],         iconBg: '#24292E', iconColor: '#fff', iconLabel: 'GH', authType: 'oauth' },
    { id: 'linear',     name: 'Linear',             linked: false, category: ['Data & Analytics'],               iconBg: '#5E6AD2', iconColor: '#fff', iconLabel: 'L', authType: 'oauth' },
    { id: 'asana',      name: 'Asana',              linked: false, category: ['Data & Analytics'],               iconBg: '#F06A6A', iconColor: '#fff', iconLabel: 'A', authType: 'oauth' },
    { id: 'dropbox',    name: 'Dropbox',            linked: false, category: ['Files & Docs'],                   iconBg: '#0061FF', iconColor: '#fff', iconLabel: 'D', authType: 'oauth' },
    { id: 'airtable',   name: 'Airtable',           linked: false, category: ['Data & Analytics'],               iconBg: '#FCBF49', iconColor: '#fff', iconLabel: 'AT', authType: 'oauth' },
    { id: 'trello',     name: 'Trello',             linked: false, category: ['Data & Analytics'],               iconBg: '#0079BF', iconColor: '#fff', iconLabel: 'Tr', authType: 'oauth' },
    { id: 'loom',       name: 'Loom',               linked: true,  category: ['Meeting'],                        iconBg: '#625DF5', iconColor: '#fff', iconLabel: 'Lo', authType: 'oauth' },
    { id: 'miro',       name: 'Miro',               linked: false, category: ['Files & Docs', 'Tanka Official'], iconBg: '#FFD02F', iconColor: '#050038', iconLabel: 'M', authType: 'oauth' },
    ...
    { id: 'hubspot',    name: 'HubSpot',            linked: false, category: ['Data & Analytics'],               iconBg: '#FF7A59', iconColor: '#fff', iconLabel: 'HS', authType: 'oauth' },
    { id: 'salesforce', name: 'Salesforce',         linked: false, category: ['Data & Analytics'],               iconBg: '#00A1E0', iconColor: '#fff', iconLabel: 'SF', authType: 'oauth' },
    { id: 'intercom',   name: 'Intercom',           linked: false, category: ['Emails & Messengers'],            iconBg: '#1F8DED', iconColor: '#fff', iconLabel: 'IC', authType: 'oauth' },
    { id: 'zapier',     name: 'Zapier',             linked: false, category: ['Others'],                         iconBg: '#FF4A00', iconColor: '#fff', iconLabel: 'Zp', authType: 'oauth' },
    { id: 'monday',     name: 'Monday.com',         linked: false, category: ['Data & Analytics'],               iconBg: '#FF3D57', iconColor: '#fff', iconLabel: 'Mo', authType: 'oauth' },
    { id: 'clickup',    name: 'ClickUp',            linked: false, category: ['Data & Analytics'],               iconBg: '#7B68EE', iconColor: '#fff', iconLabel: 'CU', authType: 'oauth' },
    { id: 'webex',      name: 'Webex',              linked: false, category: ['Meeting'],                        iconBg: '#00BCF2', iconColor: '#fff', iconLabel: 'Wx', authType: 'oauth' },
    { id: 'gmeet',      name: 'Google Meet',        linked: true,  category: ['Meeting'],                        iconBg: '#00897B', iconColor: '#fff', iconLabel: 'GM', authType: 'oauth' },
    { id: 'discord',    name: 'Discord',            linked: false, category: ['Emails & Messengers'],            iconBg: '#5865F2', iconColor: '#fff', iconLabel: 'Dc', authType: 'oauth' },
    ...
    { id: 'power-bi',   name: 'Power BI',           linked: false, category: ['Data & Analytics', 'Tanka Official'], iconBg: '#F2C811', iconColor: '#000', iconLabel: 'PB', authType: 'oauth' },
    { id: 'tanka-ai',   name: 'Tanka AI',           linked: true,  category: ['Tanka Official', 'AI Models'],    iconBg: '#000', iconColor: '#fff', iconLabel: 'Ta', authType: 'api-key' },
  ]);
